import{a as m,j as e}from"./index-DIWT0Dih.js";import{x as b,y as p,M as d,z as x,B as j,v as y,I as _,C as g,D as w,T as N,E as T,F as i,G as n,H as v,J as t,L as q,K as A}from"./use-toast-bOthieAg.js";const $=new b(new p({network:d,fullnode:`https://aptos-${d}.nodit.io/${x}/v1`,indexer:`https://aptos-${d}.nodit.io/${x}/v1/graphql`}));function E(){return $}function k(s){return j({queryKey:["nodit-indexer-api",s],refetchInterval:!1,enabled:s.length>0,queryFn:async()=>{try{if(!s)return null;const r=(await E().queryIndexer({query:{variables:{accountAddress:s},query:`
