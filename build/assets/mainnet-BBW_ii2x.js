import{a3 as b,a4 as j,T as i,a5 as u,a6 as y,j as e,L as o,a7 as g,a as f,N as _,a8 as w,a9 as N,aa as T,ab as v,ac as q,ad as x,ae as n,af as A,ag as t,ah as $}from"./WalletSelector-Ng8UPMxT.js";const k=new b(new j({network:i,fullnode:`https://aptos-${i}.nodit.io/${u}/v1`,indexer:`https://aptos-${i}.nodit.io/${u}/v1/graphql`}));function S(){return k}function E(s){return y({queryKey:["nodit-indexer-api",s],refetchInterval:!1,enabled:s.length>0,queryFn:async()=>{try{if(!s)return null;const r=(await S().queryIndexer({query:{variables:{accountAddress:s},query:`
