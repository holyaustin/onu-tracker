import{I as p,J as b,N as d,K as u,L as j,j as e,a as m,C as y,M as g,O as _,P as w,T as N,U as T,V as i,W as n,X as v,Y as t,Z as q,_ as A}from"./use-toast-Draf2wwh.js";const $=new p(new b({network:d,fullnode:`https://aptos-${d}.nodit.io/${u}/v1`,indexer:`https://aptos-${d}.nodit.io/${u}/v1/graphql`}));function k(){return $}function E(s){return j({queryKey:["nodit-indexer-api",s],refetchInterval:!1,enabled:s.length>0,queryFn:async()=>{try{if(!s)return null;const r=(await k().queryIndexer({query:{variables:{accountAddress:s},query:`
