import{H as b,I as p,$ as d,J as m,K as j,t as x,E as y,j as e,L as _,M as g,P as w,T as N,U as T,V as i,W as n,X as v,Y as t,Z as q,_ as $}from"./use-toast-BWlaz5DZ.js";const A=new b(new p({network:d,fullnode:`https://aptos-${d}.nodit.io/${m}/v1`,indexer:`https://aptos-${d}.nodit.io/${m}/v1/graphql`}));function E(){return A}function k(s){return j({queryKey:["nodit-indexer-api",s],refetchInterval:!1,enabled:s.length>0,queryFn:async()=>{try{if(!s)return null;const r=(await E().queryIndexer({query:{variables:{accountAddress:s},query:`
