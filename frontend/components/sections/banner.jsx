      ...
      <Container>
        <Box sx={styles.grid}>
          <Box as="form" sx={styles.domainCard}>
            <Heading className="text-center text-blue-500"> Crime Records</Heading>
            <div style={{fontSize: '24px', marginRight: '0.5rem', fontWeight: 'bolder'}} className="text-center">
              <p className='text-2xl text-center bolder'>
              Police Crime Record Management system using Blockchain and Decentralized storage.
              </p>
              <br />
              <p>
             by
       ...
       {/**
          ...
          <Box as="figure" sx={styles.illustration} className="h-5/5">
            <Image src="/images/police1.png" loading="lazy" alt="video conferencing" />
          </Box>
        </Box>
      </Container>
    </Box>
